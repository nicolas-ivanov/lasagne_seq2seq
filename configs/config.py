...
EVALUATE_AND_DUMP_LOSS_FREQUENCY = 50
...
def get_nn_params_str():
    params_str = '_gru_ln{layers_num}_hd{hidden_dim}_d{dropout_rate}_cl{cont_len}_lr{learning_rate}_gc_{gradient_clip}'
